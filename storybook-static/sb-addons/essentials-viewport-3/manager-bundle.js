try {
  (() => {
                ...
                c.exports = function (n) {
                  ...
                  return function (u) {
                    var I = function () {
                      ...
                      return (
                        x && (m.has(arguments[S]) ? (k = m.get(arguments[S])) : (x = !1)),
                        x || ((k = u.apply(null, arguments)), m.set(arguments[S], k)),
                        n > 0 &&
    ...
    var $ = Se(le()),
      ...
      Ge = v.div(({ theme: e }) => ({ fontSize: e.typography.size.s2 - 1, marginLeft: 10 })),
      He = (e, t, a) => {
        if (t === null) return;
      ...
      Fe = Q(function () {
        let [e, t] = F(),
          { viewports: a = Ie, defaultOrientation: s, defaultViewport: c, disable: b } = U(A, {}),
          p = Pe(a),
          o = oe(),
          [i, h] = G(!1);
        c &&
    ...
    H.register(B, (e) => {
      H.add(B, {
        ...
        render: () => (FEATURES?.viewportStoryGlobals ? z(Le, { api: e }) : z(Fe, null)),
      });
    });
  })();
} catch (e) {
