...
import { T as j } from './TextFieldWrapper-Do-qhpdq.js';
const x = (i) =>
  e.jsxs('svg', {
...
const b = g.forwardRef(function (d, y) {
  ...
  return e.jsxs(j, {
    ...d,
    containerClassName: l('dgsuikit:items-center', w),
    value: a,
    children: [
      c &&
        e.jsx('div', {
          className: l('dgsuikit:font-p1-regular dgsuikit:text-gray-500', T),
          children: c,
        }),
      ...
      m &&
        e.jsx('div', {
          className: l('dgsuikit:font-p1-regular dgsuikit:text-gray-500', C),
          children: m,
        }),
