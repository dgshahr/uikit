function J(p, R) {
  for (var v = 0; v < R.length; v++) {
    ...
    if (typeof l != 'string' && !Array.isArray(l)) {
      for (const _ in l)
        if (_ !== 'default' && !(_ in p)) {
          const d = Object.getOwnPropertyDescriptor(l, _);
          d && Object.defineProperty(p, _, d.get ? d : { enumerable: !0, get: () => l[_] });
        }
    }
  }
...
function F() {
  ...
  var j = {
    ...
    H = {};
  function y(t, e, n) {
    (this.props = t), (this.context = e), (this.refs = H), (this.updater = n || j);
  }
  ...
  function E(t, e, n, r, s) {
        ...
        case 'object':
          switch (t.$$typeof) {
            ...
            case R:
              ...
              break;
            case O:
              return (u = t._init), E(u(t._payload), e, n, r, s);
          }
      }
    if (u)
      return (
    ...
    var a = r === '' ? '.' : r + ':';
    if ($(t))
      for (var c = 0; c < t.length; c++) (r = t[c]), (i = a + h(r, c)), (u += E(r, e, n, i, s));
    else if (((c = G(t)), typeof c == 'function'))
      for (t = c.call(t), c = 0; !(r = t.next()).done; )
        (r = r.value), (i = a + h(r, c++)), (u += E(r, e, n, i, s));
    else if (i === 'object') {
      if (typeof t.then == 'function') return E(W(t), e, n, r, s);
      throw (
        ((e = String(t)),
        Error(
  ...
  return (
    ...
    (o.cloneElement = function (t, e, n) {
      ...
      return g(t.type, s, void 0, void 0, i, r);
    }),
    ...
    (o.createElement = function (t, e, n) {
      ...
      if (e != null)
        for (r in (e.key !== void 0 && (i = '' + e.key), e))
          N.call(e, r) && r !== 'key' && r !== '__self' && r !== '__source' && (s[r] = e[r]);
      var u = arguments.length - 2;
      if (u === 1) s.children = n;
      else if (1 < u) {
        for (var a = Array(u), c = 0; c < u; c++) a[c] = arguments[c + 2];
    ...
    (o.startTransition = function (t) {
      ...
      try {
        var r = t(),
          s = f.S;
        s !== null && s(n, r),
          typeof r == 'object' && r !== null && typeof r.then == 'function' && r.then(X, I);
      } catch (i) {
        I(i);
      } finally {
        f.T = e;
...
var L;
function tt() {
  return L || ((L = 1), (A.exports = F())), A.exports;
}
var U = tt();
const et = V(U),
  rt = J({ __proto__: null, default: et }, [U]);
export { et as R, tt as a, rt as b, nt as c, V as g, U as r };
