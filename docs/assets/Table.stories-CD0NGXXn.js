...
import { B as H } from './index-CK5dQjob.js';
import { c } from './clsx-B-dksMZM.js';
import { i as V } from './isBrowser-CEYOmsdG.js';
import { B as X } from './index--PMV3f1E.js';
import { C as ee } from './index-BuYsO2Xg.js';
import { T as O } from './index-kh85Mhac.js';
import { I as te } from './IconArrowDown2-BBhufJ55.js';
import { I as ie } from './IconInfoCircleOutline-Dd1i2qLz.js';
import { D as R } from './index-vjak5aSN.js';
import { P as se } from './index-CSU41_2E.js';
/* empty css               */ import './IconMinus4-BhTKwdYo.js';
import './omitObjects-DTdUR98j.js';
import './RadioCheckboxWrapper-BkBBJRW1.js';
          ...
          l(
            new IntersectionObserver(
              (u) => {
                ...
                d || document?.querySelectorAll('[id^="sticky-cell-"]').forEach(re);
              },
...
function L(t, i) {
  return e.jsxs('div', {
    ...
    children: [
      ...
      i && (i.anchorIcon ?? e.jsx(ie, { width: w, height: w })),
    ],
  });
}
function q(t, i) {
            ...
            children: e.jsxs('div', {
              ...
              children: [
                C(s?.align, {
                  ...
                  isIndeterminate: !le(q(n, o), s.selectedRowKeys),
...
function S(t) {
  ...
  return e.jsxs('div', {
    ...
    children: [
      ...
      d && e.jsx(se, { className: c('dgsuikit:py-4 dgsuikit:!px-0', n?.className), ...n }),
    ],
  });
}
...
const Le = {
  ...
  v = { data: de, columns: ce, className: 'dgsuikit:w-[800px]', layout: 'fixed', rowKey: 'id' },
  x = { args: v },
  b = {
    args: {
      ...v,
...
const qe = ['Default', 'WithHeaderAndPagination', 'WithSelection', 'LongTable'];
export {
  x as Default,
  T as LongTable,
