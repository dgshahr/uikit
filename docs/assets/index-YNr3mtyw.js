...
function p({
  ...
  return [
    ...
    d ? 'dgs-ui-kit-w-full dgs-ui-kit-justify-center' : 'dgs-ui-kit-w-fit',
    c[u][g],
    s ? m[r] : b[r],
    Number(e?.length) > 0 && e,
  ]
  ...
  i.jsxs('button', {
    ...
    children: [
      ...
      a &&
        i.jsx('div', {
          className:
            'dgs-ui-kit-absolute dgs-ui-kit-top-0 dgs-ui-kit-left-0 dgs-ui-kit-w-full dgs-ui-kit-h-full dgs-ui-kit-flex dgs-ui-kit-items-center dgs-ui-kit-justify-center',
