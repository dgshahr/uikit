...
import { R as h } from './RadioCheckboxWrapper-BqJzvUnQ.js';
const i = (s) =>
  e.jsx('svg', {
...
i.__docgenInfo = { description: '', methods: [], displayName: 'CheckmarkIcon' };
const r = (s) =>
  e.jsx('svg', {
    xmlns: 'http://www.w3.org/2000/svg',
    width: '1em',
...
r.__docgenInfo = { description: '', methods: [], displayName: 'Minus4Icon' };
const p = (s) => {
