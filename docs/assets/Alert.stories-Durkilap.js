...
function I(i, r) {
  ...
  return (
    ...
    e.jsx(t, {
      className: a('dgs-ui-kit-shrink-0 dgs-ui-kit-my-[2px]', n.icon[i]),
      width: s.icon[r],
      height: s.icon[r],
    })
  );
              ...
              (!!o?.text || !!l?.text) &&
                e.jsxs('div', {
                  className: a(
                    ...
                    t === 'large' ? 'dgs-ui-kit-mt-4' : 'dgs-ui-kit-mt-3',
                  ),
                  children: [
                    !!o?.text &&
                      e.jsx(d, {
