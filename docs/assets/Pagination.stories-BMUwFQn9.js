...
import { I } from './IconArrowLeft2-fPdVUTa8.js';
import { I as S } from './IconArrowRight2-Cp_L8K-F.js';
import { B as b } from './index-C_dYOen0.js';
/* empty css               */ const c = '...';
function f(o, g) {
  const n = g - o + 1;
  return Array.from({ length: n }, (u, t) => t + o);
}
function T({ totalCount: o, pageSize: g, siblingCount: n, currentPage: u }) {
...
const P = (o) => {
  const {
    ...
    [r, p] = j.useState(k),
    d = T({ totalCount: g, pageSize: n, siblingCount: t, currentPage: r }),
    x = d[d.length - 1];
...
const _ = ['Default'];
export { h as Default, _ as __namedExportsOrder, O as default };
