const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      './test-utils-HdcK_22i.js',
      './index-D1sGr8oY.js',
      './react-18-DpAPlAL5.js',
      './index-m6QQCFJ3.js',
    ]),
) => i.map((i) => d[i]);
import { _ as Ee } from './iframe-CaKi2_ZK.js';
import { _ as Se, a as O, b as Ae } from './chunk-XP5HYGXS-BHXC9YeQ.js';
import { r as M, R as Y, a as ge } from './index-D1sGr8oY.js';
var ne = {};
...
var Q = O({
      ...
      var r = Z(),
        ...
        a = class X {
          constructor(t, l) {
            ...
            let p = t.trim().match(l.loose ? s[h.LOOSE] : s[h.FULL]);
          ...
          comparePre(t) {
            ...
            do {
              let p = this.prerelease[l],
                o = t.prerelease[l];
              if ((r('prerelease compare', l, p, o), p === void 0 && o === void 0)) return 0;
          ...
          compareBuild(t) {
            ...
            do {
              let p = this.build[l],
                o = t.build[l];
              if ((r('build compare', l, p, o), p === void 0 && o === void 0)) return 0;
              if (o === void 0) return 1;
              if (p === void 0) return -1;
              if (p !== o) return f(p, o);
            } while (++l);
          ...
          inc(t, l, p) {
            ...
            switch (t) {
              ...
              case 'preminor':
                ...
                break;
              case 'prepatch':
                ((this.prerelease.length = 0), this.inc('patch', l, p), this.inc('pre', l, p));
                break;
              case 'prerelease':
                (this.prerelease.length === 0 && this.inc('patch', l, p), this.inc('pre', l, p));
                break;
    ...
    '../../node_modules/semver/functions/inc.js'(c, u) {
      var r = q(),
        i = (n, s, E, h, e) => {
          ...
          try {
            return new r(n instanceof r ? n.version : n, E).inc(s, h, e).version;
          } catch {
            return null;
          }
        };
  ...
  V = O({
    '../../node_modules/semver/classes/range.js'(c, u) {
      ...
      var n = Me(),
        ...
        se = (d, m) => (
          e('replaceGTE0', d, m),
          d.trim().replace(a[m.includePrerelease ? v.GTE0PRE : v.GTE0], '')
        ),
        ae = (d) => (m, L, R, _, $, N, w, g, x, j, k, B) => (
          P(R)
            ? (L = '')
            : P(_)
              ? (L = `>=${R}.0.0${d ? '-0' : ''}`)
    ...
    '../../node_modules/semver/classes/comparator.js'(c, u) {
      var r = Symbol('SemVer ANY'),
        i = class oe {
          ...
          parse(t) {
            let l = this.options.loose ? s[E.COMPARATORLOOSE] : s[E.COMPARATOR],
              p = t.match(l);
  ...
  Qe = O({
    '../../node_modules/semver/ranges/intersects.js'(c, u) {
      var r = V(),
        i = (n, s, E) => ((n = new r(n, E)), (s = new r(s, E)), n.intersects(s, E));
      u.exports = i;
    },
  }),
  Ze = O({
    '../../node_modules/semver/ranges/simplify.js'(c, u) {
      ...
      u.exports = (n, s, E) => {
        ...
        for (let p of a)
          r(p, s, E) ? ((f = p), e || (e = p)) : (f && h.push([e, f]), (f = null), (e = null));
        e && h.push([e, null]);
        let v = [];
        for (let [p, o] of h)
          p === o
      ...
      var r = V(),
        ...
        a = (l, p, o) => {
          ...
          for (let T of I) {
            ...
            for (let W of p) if (!s(T, String(W), o)) return !1;
            return !0;
          }
          let D,
            P,
        ...
        v = (l, p, o) => {
          if (!l) return p;
          let I = E(l.semver, p.semver, o);
          return I > 0 ? l : I < 0 || (p.operator === '>' && l.operator === '>=') ? p : l;
        },
        t = (l, p, o) => {
          if (!l) return p;
          let I = E(l.semver, p.semver, o);
...
var Oe = async () => {
    if (typeof tr.act != 'function') {
      let c = await Ee(
        () => import('./test-utils-HdcK_22i.js').then((u) => u.t),
        __vite__mapDeps([0, 1]),
        import.meta.url,
      );
      c?.default?.act ?? c.act;
...
async function lr(
  ...
  let { renderElement: E, unmountElement: h } = await Ee(
      async () => {
        const { renderElement: t, unmountElement: l } = await import('./react-18-DpAPlAL5.js');
  ...
  return (
    await new Promise(async (t, l) => {
      (ue.push(async () => {
        try {
          (await v(async () => {
            await E(a, s, c?.parameters?.react?.rootOptions);
          }),
            t());
        } catch (p) {
          l(p);
...
var or = (c) => async (u) => (
    u != null && (c.originalStoryFn = () => u),
    await c.renderToCanvas(),
    c.canvas
  ),
  ur = { renderer: 'react' },
  Er = [
