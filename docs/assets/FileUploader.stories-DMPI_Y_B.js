...
import { I as G } from './IconPlus4-BNix8Omv.js';
import { B as w } from './index-CPHIRs0n.js';
import { F as N } from './FieldBottomInfo-Cv8aBHkK.js';
import { P as W } from './index-C9MioMcJ.js';
import { I as V } from './IconEye-Cb9e2e14.js';
...
q.__docgenInfo = { description: '', methods: [], displayName: 'FileInputIcon' };
const E = 'dgsuikit:h-[190px] dgsuikit:w-[330px]',
  _ = 'dgsuikit:size-[120px]',
  L =
...
function X(t) {
  ...
  return typeof t == 'boolean'
    ? e.jsx(w, { className: i, rightIcon: e.jsx(G, {}), size: 'small' })
...
const S = (t) => {
  ...
  return e.jsxs('div', {
    ...
    children: [
      ...
      !h && Object.keys(p ?? {}).length > 0 && e.jsx(N, { ...p }),
    ],
  });
};
S.__docgenInfo = {
...
j.__docgenInfo = { description: '', methods: [], displayName: 'IconDelete1' };
const B = (t) =>
  e.jsx('svg', {
    xmlns: 'http://www.w3.org/2000/svg',
    width: '1em',
...
const Y =
  ...
  F = (t) => {
    ...
    return e.jsxs('div', {
      className: d('dgsuikit:relative dgsuikit:rounded-lg dgsuikit:overflow-hidden', E, a),
      children: [
        e.jsx('img', {
        ...
        e.jsxs('div', {
          className: d(
            ...
            i.loading ? 'dgsuikit:bg-black/70' : 'dgsuikit:bg-black/50',
          ),
          children: [
...
const A = (t) => {
  ...
  return e.jsx('div', {
    className: d(T(i.loading, i.errorMessage ? 'error' : i.status), _, s),
    children: e.jsxs(F, {
      file: i,
...
R.__docgenInfo = { description: '', methods: [], displayName: 'IconDelete' };
const D = (t) => {
  const {
      files: i,
      previewClassName: r,
  ...
  return e.jsxs('div', {
    ...
    children: [
      e.jsx(F, { file: i, className: 'dgsuikit:!size-[72px] dgsuikit:shrink-0' }),
      !!(c ?? u) &&
        e.jsxs('div', {
          ...
          children: [
            ...
            u && e.jsx(N, { hintMessage: p, errorMessage: o }),
          ],
        }),
      (a || n || s) &&
        e.jsxs('div', {
...
const H = (t) => {
  ...
  return r === 'grid'
    ? i.map((n) => e.jsx(A, { ...t, files: n }, M(n)))
    : e.jsx('div', {
        className: d('dgsuikit:mt-4 dgsuikit:space-y-2', a),
        children: i.map((n) => e.jsx(D, { ...t, files: n }, M(n))),
      });
};
H.__docgenInfo = {
  description: '',
...
const O = (t) => {
  ...
  return e.jsxs('div', {
    ...
    children: [
      ...
      (m ?? o) ? e.jsx(N, { errorMessage: o, hintMessage: m }) : null,
    ],
  });
};
O.__docgenInfo = {
  ...
  return e.jsxs(u, {
    ...
    children: [
      ((!g && i === 'single') || (i === 'multiple' && !m)) &&
        e.jsx(S, { ...r, previewtype: o?.type, disabled: n, isError: a, onChange: s }),
      g &&
        e.jsx(e.Fragment, {
          children: i === 'single' ? e.jsx(O, { ...o, files: l }) : e.jsx(H, { ...o, files: l }),
        }),
    ],
  });
};
...
const ce = ['Default', 'MultipleGrid', 'MultipleList'];
export {
  x as Default,
  C as MultipleGrid,
  P as MultipleList,
