...
import { r as W } from './index-DatCARk7.js';
import { c as U } from './clsx-B-dksMZM.js';
import { B as R } from './index-CrGd0T88.js';
import { u as _t, P as It } from './PickerWrapper-CQk-H8xq.js';
import { I as qt } from './IconArrowDown2-BBhufJ55.js';
import { I as Ft } from './IconArrowLeft2-DI3fgQDw.js';
import { I as Bt } from './IconArrowRight2-C2yC-io_.js';
/* empty css               */ import './index-DCurtzxY.js';
import './index-JDkdBrmE.js';
import './index-C9zM6nuj.js';
import './IconCloseRemove-B6m37iwz.js';
import './index-gGl_gCpq.js';
import './IconEye-Cb9e2e14.js';
import './omitObjects-DTdUR98j.js';
import './TextFieldWrapper-BRMu060s.js';
...
function j(t) {
  return (e, n = {}) => {
    ...
    const i = s[0],
      ...
      o = Array.isArray(u) ? re(u, (h) => h.test(i)) : ne(u, (h) => h.test(i));
    let m;
...
function b(t, e, n) {
  ...
  let o = e
    ...
    .map((c) => {
      ...
      const h = c[0];
      if (h === "'") return { isToken: !1, value: ze(c) };
...
function Ze(t) {
  ...
  const n = L(t),
    r = X(t),
    a = K({ start: X(t), end: L(t) }).map((u) => ({ date: u, isInMonth: !0 })),
    s = pt(r),
    i = pt(n);
  if (
    (s !== 6
    ...
    const u = K({ start: et(n, 1), end: Ue(n) }).map((o) => ({ date: o, isInMonth: !1 }));
    e = [...e, ...u];
  }
  return e;
}
function tn({ date: t, isInMonth: e, showExtraDays: n, value: r, startDate: a, endDate: s }) {
  ...
  return (
    u && (c = `${c} dgs-ui-kit-border dgs-ui-kit-border-primary-300`),
    !e && i ? (c = `${c} dgs-ui-kit-text-gray-400`) : (c = `${c} dgs-ui-kit-text-gray-600`),
    o || (c = `${c} dgs-ui-kit-line-through dgs-ui-kit-pointer-events-none`),
    r instanceof Date
      ? q(r, t) && (c = `${c} ${m}`)
      : r.start && q(r.start, t)
        ? (c = `${c} dgs-ui-kit-rounded-l-none ${m}`)
        : r.end && q(r.end, t)
          ? (c = `${c} dgs-ui-kit-rounded-r-none ${m}`)
          : r.start &&
            r.end &&
            st(t, { start: r.start, end: r.end }) &&
            (c = `${c} dgs-ui-kit-rounded-none dgs-ui-kit-border-none dgs-ui-kit-bg-primary-50 dgs-ui-kit-text-primary-500`),
    c
  );
}
const Wt = () => {
...
const Nt = () => {
  ...
  return d.jsx('div', {
    ...
    children: rn({ start: t, end: sn(t) }).map((s) =>
      d.jsx(
        'button',
        {
          type: 'button',
...
const _n = ['Default', 'Range'];
export { F as Default, B as Range, _n as __namedExportsOrder, En as default };
