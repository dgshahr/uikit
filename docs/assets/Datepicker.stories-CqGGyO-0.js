...
import { f as Fe } from './helpers-BLnSDN_K.js';
import { c as re } from './clsx-B-dksMZM.js';
import { B as V } from './index-DwcRcLHF.js';
import { u as Be, P as $e } from './PickerWrapper-DbiUxPuM.js';
...
/* empty css               */ import './index-RR5qjxEm.js';
...
function Qe(e, t, n) {
  ...
  const i = t - 1,
    s = e,
    o = n;
  let u = De - 1 + 365 * (s - 1) + k(8 * s + 21, 33);
...
function ve(e, t) {
  if (((t = t - 1), t < 0)) {
    const n = t;
    (t = Ue(t, 12)), (e -= k(t - n, 12));
  }
  return t > 11 && ((e += k(t, 12)), (t = ae(t, 12))), [e, t + 1];
}
function k(e, t) {
  return ~~(e / t);
}
...
function oe(e, t) {
  const n = h(e, t?.in);
  return O(n, b(n), 0, 1), n.setHours(0, 0, 0, 0), n;
}
function jt(e, t) {
  const n = h(e, t?.in);
  return Yt(n, oe(n)) + 1;
...
function Pe(e, t) {
  const n = h(e, t?.in),
    ...
    i =
      ...
      1,
    s = w(t?.in || e, 0);
  O(s, r + 1, 0, i), s.setHours(0, 0, 0, 0);
  const o = Y(s, t),
    u = w(t?.in || e, 0);
  O(u, r, 0, i), u.setHours(0, 0, 0, 0);
  const l = Y(u, t);
...
function Ht(e, t) {
  const n = B(),
    ...
    a = Pe(e, t),
    i = w(t?.in || e, 0);
  return O(i, a, 0, r), i.setHours(0, 0, 0, 0), Y(i, t);
}
function Rt(e, t) {
  const n = h(e, t?.in),
    r = +Y(n, t) - +Ht(n, t);
...
function ke(e, t) {
  return e % 60 === 0 ? (e > 0 ? '-' : '+') + m(Math.abs(e) / 60, 2) : N(e, t);
}
function N(e, t = '') {
  const n = e > 0 ? '-' : '+',
    r = Math.abs(e),
...
const we = (e, t) => {
  ...
  _t = (e, t) => {
    ...
    return i.replace('{{date}}', we(r, t)).replace('{{time}}', Oe(a, t));
  },
  Ft = { p: Oe, P: _t },
  Bt = /^D+$/,
  $t = /^Y+$/,
...
function z(e, t) {
  const n = h(e, t?.in),
    r = x(n);
  return O(n, b(n), r + 1, 0), n.setHours(23, 59, 59, 999), n;
}
function rn(e, t) {
  const n = B(),
...
function ie(e, t) {
  const n = h(e, t?.in),
    r = b(n);
  return O(n, r + 1, 0, 0), n.setHours(23, 59, 59, 999), n;
}
function se(e, t) {
...
function on(e, t = [], n = []) {
  ...
  if (
    ...
    const l = ne({ start: ue(a, 1), end: rn(a) }).map((d) => ({
      date: d,
      isInMonth: !1,
      isDisabled: C(t, d),
      isHoliday: C(n, d),
...
function dn(e, t) {
  ...
  let o = 1;
  const u = [];
  for (; +s <= i; ) u.push(w(n, s)), me(s, x(s) + o);
  return a ? u.reverse() : u;
}
const Ce = () => {
  ...
  return c.jsx('div', {
    ...
    children: dn({ start: oe(e), end: ie(e) }).map((i) =>
      c.jsx(
        'button',
        {
          type: 'button',
...
function ln(e, t) {
  ...
  const i = a ? +n : +r,
    s = a ? r : n;
  s.setHours(0, 0, 0, 0), me(s, 0, 1);
  let o = 1;
  const u = [];
  for (; +s <= i; ) u.push(w(n, s)), O(s, b(s) + o);
  return a ? u.reverse() : u;
}
function fe(e, t, n) {
  const r = h(e, n?.in);
...
je.__docgenInfo = { description: '', methods: [], displayName: 'Footer' };
function qe(e, t, n) {
  const {
      years: r = 0,
      months: a = 0,
...
function yn(e, t, n) {
  switch (t) {
    case p.Day:
      return K(e, qe(n, { days: 1 }));
    case p.Month:
      return U(e, n);
    case p.Year:
      return le(n, { start: e, end: _(e, { years: 12 }) });
  }
}
function pn(e, t, n) {
  switch (t) {
...
const $ = (e) => {
  ...
  return (
    a.dropdownType === 'drawer'
      ? (a.drawerProps = {
          ...a.drawerProps,
          containerClassName: re('dgsuikit:!p-0', a.drawerProps?.containerClassName),
        })
      : (a.popoverClassName = re('dgsuikit:!p-0 dgsuikit:max-h-max', a.popoverClassName)),
    a.customInput || (a.inputProps = { ...a.inputProps, value: a.inputProps?.value ?? kn(r) }),
    c.jsx($e, {
      ...a,
      children: c.jsxs(Ne, {
        datepickerProps: e,
        children: [c.jsx(Ee, {}), c.jsx(Ye, {}), (t || n) && c.jsx(je, {})],
      }),
    })
  );
};
...
const Vn = {
  ...
  I = { args: { value: new Date(), onChange: () => {} }, render: (e) => c.jsx(wn, { ...e }) },
  A = {
    ...I,
    args: {
      ...I.args,
...
const Qn = ['Default', 'DisableAndHoliday', 'Range', 'DayHoverAction'];
export {
  X as DayHoverAction,
  I as Default,
