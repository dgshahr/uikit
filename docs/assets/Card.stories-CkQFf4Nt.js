...
const g = {
  ...
  v = { default: 'dgs-ui-kit-text-gray-700', primary: 'dgs-ui-kit-text-primary-500' },
  b = { small: 'dgs-ui-kit-font-h5-bold', medium: 'dgs-ui-kit-font-h3-bold' },
  h = (i) => {
    const {
        variant: r = 'default',
        size: a = 'medium',
      ...
      m = c('dgs-ui-kit-font-bold', v[r], b[a]);
    return e.jsxs('div', {
      className: o,
      children: [
        e.jsxs('div', {
        ...
        e.jsx('div', { className: 'dgs-ui-kit-w-full', children: t }),
      ],
    });
  };
h.__docgenInfo = { description: '', methods: [], displayName: 'CardHeader' };
const f = 'dgs-ui-kit-border-t-0 dgs-ui-kit-rounded-t-none',
  k = (i) => {
    const {
        header: r,
        children: a,
