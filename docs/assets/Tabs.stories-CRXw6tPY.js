...
import { f as y } from './helpers-jvLsOI0h.js';
import { c as o } from './clsx-B-dksMZM.js';
import { B as k } from './index-Hns_H_aV.js';
/* empty css               */ const a = (s) =>
  t.jsx('svg', {
...
a.__docgenInfo = { description: '', methods: [], displayName: 'IconUserBold' };
const l = (s) => {
  const {
      activeKey: i,
      onChange: u,
    ...
    children: c.map((e) =>
      t.jsxs(
        'button',
        {
          ...
          onClick: () => u(e.key),
          disabled: e.disabled,
          className: o('dgs-ui-kit-group', { 'dgs-ui-kit-flex-1': n && d }),
          children: [
            t.jsxs('div', {
              className: o(
              ...
              children: [
                e.icon
                  ? t.jsx('div', {
                      className: o('dgs-ui-kit-transition', {
...
`,
  ...
  r = {
    args: {
      ...
      items: [
        { key: 1, title: 'تب اول', icon: t.jsx(a, {}), badgeNumber: 1 },
        { key: 2, title: 'تب دوم', icon: t.jsx(a, {}), badgeNumber: 1 },
        { key: 3, title: 'تب سوم', icon: t.jsx(a, {}), badgeNumber: 1, disabled: !0 },
      ],
    },
  };
r.parameters = {
...
const j = ['Default'];
export { r as Default, j as __namedExportsOrder, v as default };
