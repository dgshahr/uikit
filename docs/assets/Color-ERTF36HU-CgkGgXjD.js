...
u.rgb.hsl = function (e) {
  ...
  const i = (o + a) / 2;
  return (
    a === o ? (c = 0) : i <= 0.5 ? (c = l / (a + o)) : (c = l / (2 - a - o)), [s, c * 100, i * 100]
  );
};
...
function He(e, t) {
  ...
  let r = X[t[e].parent][e],
    o = t[e].parent;
  for (; t[o].parent; ) n.unshift(t[o].parent), (r = ze(X[t[o].parent][o], r)), (o = t[o].parent);
...
Le.forEach((e) => {
  (I[e] = {}),
    Object.defineProperty(I[e], 'channels', { value: K[e].channels }),
    Object.defineProperty(I[e], 'labels', { value: K[e].labels });
  const t = Pe(e);
  Object.keys(t).forEach((r) => {
    const o = t[r];
    (I[e][r] = Be(o)), (I[e][r].raw = qe(o));
  });
});
var Xe = I;
const _ = fe(Xe);
...
function ft(e, t, n) {
  ...
  function S(v) {
    return (i = v), (s = setTimeout(m, t)), d ? w(v) : l;
  }
  function E(v) {
    var M = v - c,
      T = v - i,
  ...
  function j() {
    ...
    if (((r = arguments), (o = this), (c = v), M)) {
      ...
      if (f) return clearTimeout(s), (s = setTimeout(m, t)), w(c);
    }
...
var N = function (e, t, n) {
  ...
  oe = function (e, t, n) {
    var r = e.getBoundingClientRect(),
      o = z(t)
        ...
        : t;
    return {
      left: N((o.pageX - (r.left + A(e).pageXOffset)) / r.width),
      top: N((o.pageY - (r.top + A(e).pageYOffset)) / r.height),
    };
  },
  ae = function (e) {
      ...
      i = b.useMemo(
        function () {
          ...
          function E(p) {
            ...
            y(m ? 'touchmove' : 'mousemove', w), y(m ? 'touchend' : 'mouseup', S);
          }
          return [
            function (p) {
              var m = p.nativeEvent,
              ...
              if (
                ...
                k.focus(), a(oe(k, m, s.current)), E(!0);
              }
            },
            function (p) {
    ...
    return (
      ...
      e.length < 6
        ? {
            ...
            a: e.length === 4 ? x(parseInt(e[3] + e[3], 16) / 255, 2) : 1,
          }
        : {
            r: parseInt(e.substring(0, 2), 16),
            g: parseInt(e.substring(2, 4), 16),
            b: parseInt(e.substring(4, 6), 16),
            a: e.length === 8 ? x(parseInt(e.substring(6, 8), 16) / 255, 2) : 1,
          }
    );
  },
  mt = function (e, t) {
    return t === void 0 && (t = 'deg'), Number(e) * (gt[t] || 1);
  },
  vt = function (e) {
    var t =
  ...
  ge = function (e) {
    ...
    return {
      h: x(e.h),
      s: x(o > 0 && o < 200 ? ((t * n) / 100 / (o <= 100 ? o : 200 - o)) * 100 : 0),
      l: x(o / 2),
      a: x(r, 2),
    };
  },
    ...
    return h.createElement(
      ...
      h.createElement(
        Q,
        {
          ...
          onKey: function (o) {
            n({ s: N(t.s + 100 * o.left, 0, 100), v: N(t.v - 100 * o.top, 0, 100) });
          },
          'aria-label': 'Color',
          'aria-valuetext': 'Saturation ' + x(t.s) + '%, Brightness ' + x(t.v) + '%',
        },
        h.createElement(Z, {
  ...
  kt = function (e, t) {
    return e.toLowerCase() === t.toLowerCase() || ye(G(e), G(t));
  };
function we(e, t, n) {
  var r = V(n),
  ...
  var c = b.useCallback(function (i) {
    l(function (d) {
...
var _t = typeof window < 'u' ? b.useLayoutEffect : b.useEffect,
  Et = function () {
  ...
  Mt = function (e) {
    var t = e.className,
      ...
      a = e.onChange,
      l = J(e, ['className', 'colorModel', 'color', 'onChange']),
      s = b.useRef(null);
    ke(s);
    var c = we(n, o, a),
      i = c[0],
    ...
    return h.createElement(
      ...
      h.createElement(ve, { hue: i.h, onChange: d, className: 'react-colorful__last-control' }),
    );
  },
  Ct = {
    defaultColor: '000',
    toHsva: bt,
    fromHsva: function (e) {
      return yt({ h: e.h, s: e.s, v: e.v, a: 1 });
    },
    equal: kt,
  },
  $t = function (e) {
    return h.createElement(Mt, $({}, e, { colorModel: Ct }));
  },
  It = function (e) {
    var t = e.className,
      n = e.hsva,
  ...
  _e = function (e) {
    ...
    return h.createElement(
      ...
      h.createElement(It, { hsva: i, onChange: d, className: 'react-colorful__last-control' }),
    );
  },
  Ot = { defaultColor: 'hsla(0, 0%, 0%, 1)', toHsva: vt, fromHsva: B, equal: xe },
  Nt = function (e) {
    return h.createElement(_e, $({}, e, { colorModel: Ot }));
  },
  St = {
  ...
  Rt = function (e) {
    return h.createElement(_e, $({}, e, { colorModel: St }));
  },
  jt = C.div({ position: 'relative', maxWidth: 250, '&[aria-readonly="true"]': { opacity: 0.5 } }),
  Tt = C(ue)({
    position: 'absolute',
    zIndex: 1,
    top: 4,
  ...
  Ht = C($e)(({ theme: e }) => ({ fontFamily: e.typography.fonts.base })),
  Ft = C.div({
    display: 'grid',
  ...
  Gt = (e, t) => {
    let [n, r] = b.useState(e || ''),
      [o, a] = b.useState(() => O(n)),
      [l, s] = b.useState(o?.colorSpace || 'hex');
    b.useEffect(() => {
      let f = e || '',
        g = O(f);
      r(f), a(g), s(g?.colorSpace || 'hex');
    }, [e]);
    let c = b.useMemo(() => At(n, o, l).toLowerCase(), [n, o, l]),
      i = b.useCallback(
        (f) => {
          let g = O(f),
            w = g?.value || f || '';
    ...
    return { value: n, realValue: c, updateValue: i, color: o, colorSpace: l, cycleColorSpace: d };
  },
  D = (e) => e.replace(/\s*/, '').toLowerCase(),
  Ut = (e, t, n) => {
    let [r, o] = b.useState(t?.valid ? [t] : []);
    b.useEffect(() => {
      t === void 0 && o([]);
    }, [t]);
    let a = b.useMemo(
      ...
      l = b.useCallback(
        (s) => {
          s?.valid && (a.some((c) => D(c[n]) === D(s[n])) || o((c) => c.concat(s)));
        },
        [n, a],
      );
  ...
  Yt = ({
    ...
    let c = b.useCallback(dt(n, 200), [n]),
      {
        value: i,
        realValue: d,
        updateValue: f,
                ...
                E.map((y, R) =>
                  h.createElement(
                    ue,
                    {
                      key: `${y.value}-${R}`,
                      hasChrome: !1,
                      tooltip: h.createElement(Ht, { note: y.keyword || y.value }),
                    },
                    h.createElement(se, {
                      value: y[w],
