...
import { D as Be, u as $e } from './DateAndTimePickerFooter-DbkPP819.js';
...
import { B as fe } from './index-Dxb_EEwq.js';
...
const P = {
  ...
  ye = {
    ...
    k: function (e, t, n) {
      ...
      return (
        r === 0 && (r = 24),
        t === 'ko' ? n.ordinalNumber(r, { unit: 'hour' }) : m(r, t.length)
      );
    },
    m: function (e, t, n) {
...
const Gn = {
  ...
  A = {
    ...
    args: {
      ...
      highlightWeekends: !0,
      disableDates: [
        new Date(new Date(Date.now() + 1440 * 60 * 1e3)),
        new Date(new Date(Date.now() + 2880 * 60 * 1e3)),
      ],
      holidays: [
        new Date(new Date(Date.now() - 1440 * 60 * 1e3)),
        new Date(new Date(Date.now() - 2880 * 60 * 1e3)),
