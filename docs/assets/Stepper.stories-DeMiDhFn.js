...
import { r as v, R as I } from './index-Dahukp9Z.js';
...
h.parameters = {
  ...
  render: args => <HorizontalStepper {...args}>
      <HorizontalStep title="آیتم اول" activeTitle="آیتم انتخاب شده" completeTitle="مرحله تمام شده" subTitle="مرحله ۱ از ۴" icon={<IconQuestionMarkCircle />} activeIcon={<IconAlignCenter />} completeIcon={<IconCheckCircleBold />} />
      <HorizontalStep title="آیتم دوم" activeTitle="آیتم انتخاب شده" completeTitle="مرحله تمام شده" subTitle="مرحله ۲ از ۴" icon={<IconQuestionMarkCircle />} activeIcon={<IconAlignCenter />} completeIcon={<IconCheckCircleBold />} />
      <HorizontalStep title="آیتم سوم" activeTitle="آیتم انتخاب شده" completeTitle="مرحله تمام شده" subTitle="مرحله ۳ از ۴" icon={<IconQuestionMarkCircle />} activeIcon={<IconAlignCenter />} completeIcon={<IconCheckCircleBold />} />
      <HorizontalStep title="آیتم چهارم" activeTitle="آیتم انتخاب شده" completeTitle="مرحله تمام شده" subTitle="مرحله پایانی" icon={<IconQuestionMarkCircle />} activeIcon={<IconAlignCenter />} completeIcon={<IconCheckCircleBold />} />
    </HorizontalStepper>
}`,
