const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      './test-utils-BCvw5UOC.js',
      './index-DatCARk7.js',
      './react-18-CPHW6xVf.js',
      './index-C9zM6nuj.js',
    ]),
) => i.map((i) => d[i]);
import { _ as pe } from './iframe-BjeyahWm.js';
import { _ as Te, a as O, d as Ae } from './chunk-XP5HYGXS-D5tuasO7.js';
import { r as M, R as Y, b as ge } from './index-DatCARk7.js';
var ne = {};
...
var Oe = async () => {
    if (typeof tr.act != 'function') {
      let c = await pe(
        () => import('./test-utils-BCvw5UOC.js').then((u) => u.t),
        __vite__mapDeps([0, 1]),
        import.meta.url,
      );
      c?.default?.act ?? c.act;
...
async function lr(
  ...
  let { renderElement: p, unmountElement: h } = await pe(
      async () => {
        const { renderElement: t, unmountElement: l } = await import('./react-18-CPHW6xVf.js');
