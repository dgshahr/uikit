...
import { T as j } from './TextFieldWrapper-_SkQ6SWF.js';
const x = (i) =>
  e.jsxs('svg', {
...
const b = g.forwardRef(function (d, y) {
  const {
      dir: n = 'rtl',
      placeholderDir: v = n,
    ...
    [p, I] = g.useState(t.type);
  function f() {
    return e.jsx('button', {
      onClick: () => {
        typeof s == 'function' && s();
      },
      children: e.jsx(x, { className: 'dgs-ui-kit-text-gray-600', width: 20, height: 20 }),
    });
  }
  return e.jsxs(j, {
    ...d,
    containerClassName: l('dgs-ui-kit-items-center', w),
    value: a,
    children: [
      c &&
        e.jsx('div', {
          className: l('dgs-ui-kit-font-p1-regular dgs-ui-kit-text-gray-500', T),
          children: c,
        }),
      typeof s == 'function' && a && n === 'ltr' && f(),
      e.jsx('input', {
        ...q,
        ref: y,
        className: l(
        ...
        type: p,
        onInput: (o) => {
          if ((typeof t.onInput == 'function' && t.onInput(o)) || p !== 'number') return;
          const r = o.currentTarget;
          r.value.length > r.maxLength && (r.value = r.value.slice(0, r.maxLength));
        },
      }),
      typeof s == 'function' && a && n === 'rtl' && f(),
      m &&
        e.jsx('div', {
          className: l('dgs-ui-kit-font-p1-regular dgs-ui-kit-text-gray-500', C),
          children: m,
        }),
      u && e.jsx('div', { className: 'dgs-ui-kit-text-gray-600', children: u }),
      t.type === 'password' &&
        e.jsx('button', {
          type: 'button',
          onClick: () => I((o) => (o === 'text' ? 'password' : 'text')),
