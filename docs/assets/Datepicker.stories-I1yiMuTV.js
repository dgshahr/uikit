...
import { f as _t } from './helpers-jvLsOI0h.js';
import { c as U } from './clsx-B-dksMZM.js';
import { B as R } from './index-CFPV-ofR.js';
import { u as It, P as qt } from './PickerWrapper-Cc0-uhOr.js';
...
const Lt = { full: 'EEEE do MMMM y', long: 'do MMMM y', medium: 'd MMM y', short: 'yyyy/MM/dd' },
  ...
  Vt = {
    date: z({ formats: Lt, defaultWidth: 'full' }),
    time: z({ formats: Xt, defaultWidth: 'full' }),
    dateTime: z({ formats: Qt, defaultWidth: 'full' }),
  },
  Gt = {
...
function tn(t) {
  ...
  if (
    ...
    const u = K({ start: et(n, 1), end: Je(n) }).map((o) => ({ date: o, isInMonth: !1 }));
    e = [...e, ...u];
  }
  return e;
}
...
const St = () => {
  ...
  return d.jsx('div', {
    ...
    children: nn({ start: tt(t), end: Z(t) }).map((s) =>
      d.jsx(
        'button',
        {
          type: 'button',
    ...
    children: [
      d.jsxs('button', {
        ...
        children: [
          ...
          d.jsx(Ft, { width: 20, height: 20, className: 'dgs-ui-kit-text-gray-600' }),
        ],
      }),
      d.jsxs('div', {
...
const qn = ['Default', 'Range'];
export { F as Default, B as Range, qn as __namedExportsOrder, In as default };
