...
import { r as g } from './index-D1sGr8oY.js';
import { I } from './IconEye-Cb9e2e14.js';
import { o as k } from './omitObjects-DTdUR98j.js';
import { T as j } from './TextFieldWrapper-DNVstrLk.js';
const h = (r) =>
  e.jsxs('svg', {
...
const b = g.forwardRef(function (l, y) {
  const {
    ...
    [d, N] = g.useState(t.type);
  function f() {
    return e.jsx('button', {
      onClick: () => {
        typeof i == 'function' && i();
      },
      children: e.jsx(h, { className: 'dgsuikit:text-gray-600', width: 20, height: 20 }),
    });
  }
  return e.jsxs(j, {
    ...l,
    ...
    children: [
      ...
      t.type === 'password' &&
        e.jsx('button', {
          type: 'button',
          onClick: () => N((a) => (a === 'text' ? 'password' : 'text')),
          className: 'dgsuikit:text-gray-600',
          children:
            d === 'password'
              ? e.jsx(I, { width: 20, height: 20 })
