try {
  (() => {
                ...
                i.exports = function (a) {
                  ...
                  return function (C) {
                    var m = function () {
                      ...
                      return (
                        O && (b.has(arguments[_]) ? (w = b.get(arguments[_])) : (O = !1)),
                        O || ((w = C.apply(null, arguments)), b.set(arguments[_], w)),
                        a > 0 &&
    ...
    var Ac = __STORYBOOK_CLIENT_LOGGER__,
      { deprecate: Oc, logger: K, once: Ec, pretty: Bc } = __STORYBOOK_CLIENT_LOGGER__;
    var W = Ie(X());
    p();
    h();
    f();
