...
function getDayClassName({
  ...
  const isDisabled = disableDates?.length && disableDates.some((dDate) => isSameDay(dDate, date));
  ...
  if (isDisabled) className = `${className} dgsuikit:bg-gray-200 dgsuikit:pointer-events-none`;
