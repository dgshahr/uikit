...
const IconScanDeliveryBoxIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="m8.039 8.49 3.048-1.76a1.98 1.98 0 0 1 2.023 0l3.047 1.76a2.02 2.02 0 0 1 1.01 1.75v3.52c0 .72-.384 1.39-1.01 1.75l-3.048 1.76c-.31.178-.655.268-1 .27h-.016c-.347 0-.694-.09-1.005-.27l-3.05-1.76a2.02 2.02 0 0 1-1.01-1.75v-3.52a2.02 2.02 0 0 1 1.01-1.75m3.31 3.926-2.821-1.63v2.974c0 .18.1.36.26.45h.002l2.56 1.479zm4.319-1.632L12.85 12.41v3.276l2.558-1.477c.16-.09.26-.27.26-.45zm-.764-1.293-2.545-1.46a.49.49 0 0 0-.522 0L9.289 9.492l2.806 1.62z"
      clipRule="evenodd"
    />
  </svg>
);
export default IconScanDeliveryBoxIcon;
