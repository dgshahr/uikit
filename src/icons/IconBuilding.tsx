...
const IconBuildingIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="m14.522 11.91-3.983-3.182a2.426 2.426 0 0 0-3.01.004L3.583 11.91a1.94 1.94 0 0 0-.783 1.55v5.273a2.6 2.6 0 0 0 2.6 2.577h2.889q.006-.001.006-.008V17.02a.75.75 0 0 1 1.5 0v4.282q0 .007.006.008h2.907c.683 0 1.326-.263 1.812-.742a2.58 2.58 0 0 0 .773-1.835v-5.292a1.98 1.98 0 0 0-.77-1.531"
      clipRule="evenodd"
    />
  </svg>
);
export default IconBuildingIcon;
