...
const IconDocumentScanIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M8.4 2.25h5.65a2.8 2.8 0 0 1 2.02.861l3.792 3.95A2.8 2.8 0 0 1 20.642 9v2.996a.75.75 0 1 1-1.5 0V9a1.3 1.3 0 0 0-.362-.9L14.99 4.15a1.3 1.3 0 0 0-.938-.4H8.396A2.997 2.997 0 0 0 5.39 6.667v5.33a.75.75 0 0 1-1.5 0V6.64A4.497 4.497 0 0 1 8.4 2.25"
      clipRule="evenodd"
    />
    <path
      fill="currentColor"
...
export default IconDocumentScanIcon;
