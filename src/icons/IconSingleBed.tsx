...
const IconSingleBedIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M5.215 17.088a.75.75 0 0 1 .75.75V19.4a.75.75 0 0 1-1.5 0v-1.562a.75.75 0 0 1 .75-.75m13.571 0a.75.75 0 0 1 .75.75V19.4a.75.75 0 0 1-1.5 0v-1.562a.75.75 0 0 1 .75-.75M7.404 3.85h9.193000000000001c.54 0 .996-.001 1.386.139a2.35 2.35 0 0 1 1.415 1.415c.14.39.14.845.139 1.385v5.049a.75.75 0 0 1-1.5 0V6.904c0-.72-.012-.883-.05-.992a.85.85 0 0 0-.513-.512c-.108-.039-.271-.05-.991-.05H7.519c-.72 0-.883.011-.992.05a.85.85 0 0 0-.512.512c-.039.109-.05.272-.05.992v4.934a.75.75 0 0 1-1.5 0V6.79c0-.54-.001-.995.139-1.385a2.35 2.35 0 0 1 1.415-1.415c.39-.14.845-.14 1.385-.139"
      clipRule="evenodd"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M10.69 7.85h2.621c.54 0 .996-.001 1.385.139a2.35 2.35 0 0 1 1.415 1.415c.14.39.14.845.14 1.385v1.018a.75.75 0 0 1-1.5 0v-.903c0-.72-.012-.883-.051-.992a.85.85 0 0 0-.512-.512c-.108-.039-.272-.05-.992-.05h-2.392c-.72 0-.883.011-.992.05a.85.85 0 0 0-.512.512c-.039.109-.05.272-.05.992v.903a.75.75 0 0 1-1.5 0v-1.018c0-.54-.001-.995.14-1.385a2.35 2.35 0 0 1 1.414-1.415c.39-.14.845-.14 1.385-.14"
      clipRule="evenodd"
    />
  </svg>
);
export default IconSingleBedIcon;
